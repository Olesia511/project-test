import"./menu-active-c69b0b47.js";const d=document.querySelector(".shop-list-list"),p=document.querySelector(".shop-list-placeholder"),a="user-books";function g(){const e=document.querySelector(".js-description"),t=e.textContent,n=document.querySelector(".js-name").textContent,l=document.querySelector(".js-category"),i=l.textContent;if(window.innerWidth<768){const c=t.slice(0,86)+"…";e.textContent=c,n.slice(0,22)+"",e.textContent=c;const r=i.slice(0,34)+"…";l.textContent=r}else if(window.innerWidth>=768&&window.innerWidth<1440){const c=t.slice(0,253)+"…";e.textContent=c,e.textContent=t,l.textContent=i}else e.textContent=t,e.textContent=t,l.textContent=i}let o;localStorage.getItem(a)?o=JSON.parse(localStorage.getItem(a)):o=[];function u(e){const t=e.map(({buy_links:s="null",amazon_product_url:n="null",book_image:l="null",title:i="null",list_name:c="null",description:r="null",author:m,_id:h="null"})=>`<li class="shop-list-item" data-id="${h}">
